    ...
    <div className="max-w-7xl mx-auto py-20 h-screen">
      <div className="flex justify-center">
        <div className="sm:w-full">
          <h1 className="text-5xl font-bold leading-tight text-darken sm:text-center">Your Property, Our Priority.</h1>
          <p className="leading-7 text-gray-500 py-4 sm:px-4 tracking-tight">Your best investment opportunity won’t fit into a safety deposit box, but you can live in it.</p>
          <div className="flex justify-center">
