    ...
    return (
        <div className="flex bg-white relative shadow rounded-lg text-gray-800 hover:shadow-lg">
            <div className="flex flex-col">
                    ...
                    <Link to={`/product/${product._id}`} className="bg-gray-900 block text-center text-white px-4 py-2 w-full hover:bg-gray-700 focus:outline-none duration-150">View More</Link>
